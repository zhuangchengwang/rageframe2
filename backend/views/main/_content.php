    ...
    <div class="content-tabs hide">
        ...
        <nav class="page-tabs J_menuTabs" id="rftags">
            <div class="page-tabs-content">
                <a href="javascript:void (0);" class="active J_menuTab" data-id="<?= Url::to(['/main/system']); ?>" id="rftagsIndexLink"><?=t("首页")?></a>
        ...
        <div class="btn-group roll-nav roll-right">
            <button class="dropdown J_tabClose" data-toggle="dropdown"><?=t("关闭操作")?></button>
            <ul role="menu" class="dropdown-menu dropdown-menu-right">
                <li class="J_tabShowActive"><a><?=t("定位当前选项卡")?></a></li>
                <li class="divider"></li>
                <li class="J_tabCloseAll"><a><?=t("关闭全部选项卡")?></a></li>
                <li class="J_tabCloseOther"><a><?=t("关闭其他选项卡")?></a></li>
            </ul>
        </div>
        <a href="<?= Url::to(['site/logout']); ?>" data-method="post" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> <?=t("退出")?></a>
    </div>
